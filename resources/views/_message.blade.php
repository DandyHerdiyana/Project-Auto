...
@if(!empty(session('payment_error'))) {{-- Ensure this key matches what you set in your controller --}}
<div class="alert alert-danger alert-dismissible fade in" role="alert"> {{-- Changed alert-error to alert-danger --}}
    {{ session('payment_error') }} {{-- This should match the key used in the @if statement --}}
</div>
@endif
